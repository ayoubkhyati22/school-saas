...
import { getNotifications, createNotification } from '@/services/notification.service';
...
export default function NotificationsPage() {
  ...
  return (
    <DashboardLayout profile={profile}>
      <PageHeader
        title="Notifications"
        description="School-wide announcements and messages"
      />
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        {notif.target_role && (
                          <Badge variant={roleVariant(notif.target_role)} className="flex-shrink-0">
                            {notif.target_role}
                          </Badge>
                        )}
                        {!notif.target_role && (
                          <Badge variant="default" className="flex-shrink-0">Everyone</Badge>
                        )}
                      </div>
