...
import { getTeachers } from '@/services/profile.service';
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (profileData?.school_id) {
        try {
          const teachersData = await getTeachers(profileData.school_id);
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button onClick={handleSubmit} loading={saving}>Add Teacher</Button>
          </>
        }
      >
